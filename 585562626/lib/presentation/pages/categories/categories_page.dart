...
class _CategoriesPageState extends State<CategoriesPage> {
  Offset? _tapPosition;
  final CategoriesBloc _bloc = injector.get<CategoriesBloc>();

  void _addCategory(Category category) {
    _bloc.add(AddCategoryEvent(category));
  }

  void _updateCategory(Category category) {
    _bloc.add(UpdateCategoryEvent(category));
  }

  void _deleteNoteCategory(Category category) {
    _bloc.add(DeleteCategoryEvent(category));
  }

  void _switchPriority(Category category) {
    _bloc.add(SwitchPriorityForCategoryEvent(category));
  }
